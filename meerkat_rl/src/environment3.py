...
class Env():
    def __init__(self):
        ...
        self.position_dis = 0.0
        self.position_ang = 0.0
    ...
    def transformation(self,pose_x,pose_y,yaw):
        position_x=self.goal_x*math.cos(yaw)+self.goal_y*math.sin(yaw)-pose_x*math.cos(yaw)-pose_y*math.sin(yaw)
        position_y=-self.goal_x*math.sin(yaw)+self.goal_y*math.cos(yaw)+pose_x*math.sin(yaw)-pose_y*math.cos(yaw)
	self.position_dis=round(math.sqrt(position_x**2+position_y**2),3)
	self.position_ang=round(math.degrees(math.atan2(position_y,position_x)),3)
    ...
    def step(self, action):
        ...
        point=[self.position_dis,self.position_ang]
