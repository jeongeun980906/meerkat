...
class kinect_rgb_img_get():
    ...
    def depth_call_back(self, ros_img):
        ...
        if self. flag==True and self.flag_depth==True:
            msg1=ccam_rl()
            msg2=ccam_kf()
...
class trans():
    ...
    def transform_kf(self,x1,y1,x2,y2):
        ...
        byc=(y1+y2)/2
        bxo=cos(self.theta)*bxc-sin(self.theta)*byc+self.xc #body from object frame
